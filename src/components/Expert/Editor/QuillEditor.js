...
class QuillEditor extends React.Component {
    ...
    insertImage = (e) => {
        ...
        if (e.currentTarget && e.currentTarget.files && e.currentTarget.files.length > 0) {
            ...
            axios.post('https://csci-5709-nodejs.herokuapp.com/api/expert/uploadfiles', formData, config)
                .then(response => {
                    if (response.data.success) {
                        ...
                        quill.insertEmbed(position, "image", { src: "https://csci-5709-nodejs.herokuapp.com/" + response.data.fileName, alt: response.data.fileName });
            ...
            axios.post('https://csci-5709-nodejs.herokuapp.com/api/expert/uploadfiles', formData, config)
                .then(response => {
                    if (response.data.success) {
                        ...
                        let range = quill.getSelection();
                        let position = range ? range.index : 0;
                        quill.insertEmbed(position, "video", { src: "https://csci-5709-nodejs.herokuapp.com/uploads/" + response.data.fileName, title: response.data.fileName });
                        quill.setSelection(position + 1);
