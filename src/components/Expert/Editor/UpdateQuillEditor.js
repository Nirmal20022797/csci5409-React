...
class UpdateQuillEditor extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            editorHtml: this.props.quillContent != null || this.props.quillContent != undefined ?  this.props.quillContent : "",
    ...
    componentDidMount() {
        ...
        fetch("http://localhost:3001/api/expert/getNote/1")
    ...
    insertImage = (e) => {
        ...
        if (e.currentTarget && e.currentTarget.files && e.currentTarget.files.length > 0) {
            ...
            axios.post('http://localhost:3001/api/expert/uploadfiles', formData, config)
                .then(response => {
                    if (response.data.success) {
                        ...
                        quill.insertEmbed(position, "image", { src: "http://localhost:3001/uploads/" + response.data.fileName, alt: response.data.fileName });
            ...
            axios.post('http://localhost:3001/api/expert/uploadfiles', formData, config)
                .then(response => {
                    if (response.data.success) {
                        ...
                        let range = quill.getSelection();
                        let position = range ? range.index : 0;
                        quill.insertEmbed(position, "video", { src: "http://localhost:3001/uploads/" + response.data.fileName, title: response.data.fileName });
                        quill.setSelection(position + 1);
