            ...
            <Table className={classes.table} aria-label="simple table">
              ...
              <TableBody>
                ...
                <TableRow key='1'>
                  ...
                  <TableCell align="center">  <Button   style={{backgroundColor: "#00FF00" ,  borderColor: "#00FF00" , hover: "00A300"}}
                >
                  <FaCreativeCommonsSa/>
                </Button></TableCell>

                <TableCell align="center">
                      <Button  key= "2" onClick={() => toggleTrueFalse("2")}
                      >
                       <AiOutlineEye/>
                      </Button>
                ...
                <TableCell component="th" scope="row">
                  ...
                  <TableCell align="center">  <Button    style={{backgroundColor: "#FF0000" ,  borderColor: "#FF0000" , hover: "00A300"}} 
                >
                  <FaCreativeCommonsPd/>
                </Button></TableCell>
